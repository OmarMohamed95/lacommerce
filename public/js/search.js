...
$(document).ready(function () {
  ...
  $('#searchInput').on('keyup', function (e) {
    ...
    timeout = setTimeout(function () {
      clearMenu();
      axios.get("/api/search?q=".concat($('#searchInput').val())).then(function (response) {
        response.data[0].forEach(function (result) {
          $('#searchResultsMenu').append("<a href='/product/".concat(result.id, "'><li>").concat(result.name, " in <span class=\"bold\">").concat(result.category.name, "<span></li></a>"));
        });
