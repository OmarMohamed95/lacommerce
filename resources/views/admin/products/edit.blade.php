...
@section('content')
<h1 class="alert alert-info pageH">Edit product</h1>
<div class="col-xs-offset-1">
    <form action="{{ aurl("products/$single->id") }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <input type="hidden" id="product_id" value="{{ $single->id }}">
        <div class="form-group row">
            <div class="col-sm-10">
